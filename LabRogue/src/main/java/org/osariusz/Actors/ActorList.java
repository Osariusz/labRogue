    ...
    public static final List<Monster.MonsterBuilder<?, ?>> monsters = new ArrayList<>() {
        {
            add(new Monster().toBuilder().equipment(new HashMap<>(Map.ofEntries(
                    new AbstractMap.SimpleEntry(Actor.EquipmentSlots.WEAPON, Weapon.builder().damage(1).shootChance(10).build())
            ))).hp(2).agility(60).name("Szczur").id("rat").spawnChance(80));

            add(new Monster().toBuilder().equipment(new HashMap<>(Map.ofEntries(
                    new AbstractMap.SimpleEntry(Actor.EquipmentSlots.WEAPON, Weapon.builder().damage(1).shootChance(40).range(2).build())
            ...
            add(new Monster().toBuilder().spawnChance(10).hp(15).agility(0).equipment(new HashMap<>(Map.ofEntries(
                    new AbstractMap.SimpleEntry(Actor.EquipmentSlots.WEAPON, Weapon.builder().damage(2).shootChance(50).range(2).build())
            ))).name("Statua").id("statue"));

            add(new Monster().toBuilder().spawnChance(1).hp(100).agility(-20).equipment(new HashMap<>(Map.ofEntries(
                    new AbstractMap.SimpleEntry(Actor.EquipmentSlots.WEAPON, Weapon.builder().damage(10).shootChance(70).range(5).build())

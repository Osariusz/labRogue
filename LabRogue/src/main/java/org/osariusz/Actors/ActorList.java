    ...
    public static final List<Monster.MonsterBuilder<?, ?>> monsters = new ArrayList<>() {
        {
            ...
            add(new Monster().toBuilder().canPickItems(true).equipment(new HashMap<>(Map.ofEntries(
            ...
            add(new Monster().toBuilder().spawnChance(40).canPickItems(true).equipment(new HashMap<>(Map.ofEntries(
